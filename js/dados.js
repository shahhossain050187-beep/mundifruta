/* ═══════════════════════════════════════════════════════════
  ...
  const FOTOS = {
    ...
    melancia:     "fotos/mundifruta-photos-web/melancia_quarto.jpg",
    ...
    melao_branco: "fotos/mundifruta-photos-web/melao_branco_v2.jpg",
    melao_am:     "fotos/foto_5_1.jpeg",
    figos:        "fotos/mundifruta-photos-web/figos_v2.jpg",
    ...
    abobora:      "fotos/mundifruta-photos-web/abobora_inteira_v2.jpg",
    abobora_fatiada: "fotos/mundifruta-photos-web/abobora_fatiada_v2.jpg",
    ...
    feijao_dourado: "fotos/mundifruta-photos-web/feijao_dourado_v2.jpg",
    feijao_maduro:    "fotos/mundifruta-photos-web/feijao_maduro_v2.jpg",
  ...
  const produtos = {
    ...
    frutas: [
      { nome:"Melancia 1/4",            emoji:"🍉", topVendido:true, venda:"estimado", pricePerKg:0.99, averageWeightKg:3, peso:"1/4 de melancia • aprox. 3 kg", preco:"0,99 €", origem:"Marrocos", foto:FOTOS.melancia, badge:"🌞 Verão", badgeClass:"", rel:["Morangos","Melão Branco","Uvas sem Grainha","Hortelã"] },
      ...
      { nome:"Melão Branco",            emoji:"🍈", topVendido:true, venda:"estimado", pricePerKg:1.20, averageWeightKg:2.5, peso:"1 unidade • aprox. 2,5 kg", preco:"1,20 €", origem:"Alentejo", foto:FOTOS.melao_branco, badge:"🌞 Verão", badgeClass:"", rel:["Morangos","Melancia 1/4","Uvas sem Grainha"] },
      ...
      { nome:"Pêssego Amarelo",         emoji:"🍑", peso:"1 kg", promo:true, precoNormal:"3,49 €", preco:"1,99 €", origem:"Nacional", foto:FOTOS.pessego_amarelo, badge:"🏷️ Promoção", badgeClass:"badge-hot" },
      ...
      { nome:"Nectarina",               emoji:"🍑", peso:"1 kg", promo:true, precoNormal:"3,99 €", preco:"1,99 €", origem:"Nacional", foto:FOTOS.nectarina, badge:"🏷️ Promoção", badgeClass:"badge-hot" },
      ...
      { nome:"Cereja de Fundão",        emoji:"🍒", topVendido:true, peso:"1 kg", preco:"6,99 €", status:"Indisponível",   foto:FOTOS.cerejas,      badge:"⛔ Esgotado",  badgeClass:"badge-hot" },
      { nome:"Cereja Gardunha",         emoji:"🍒", peso:"1 kg", preco:"5,99 €", status:"Indisponível", origem:"Beira",    foto:FOTOS.cerejas,      badge:"⛔ Esgotado" , badgeClass:"badge-hot" },
      ...
      { nome:"Manga Avião",             emoji:"🥭", venda:"estimado", pricePerKg:4.99, averageWeightKg:0.65, peso:"1 unidade • aprox. 650 g", preco:"4,99 €", origem:"Espanha", foto:FOTOS.manga, badge:"🌱 Bio", badgeClass:"badge-new", rel:["Abacaxi Maturado","Mamão","Papaia","Banana Madeira"] },
      ...
      { nome:"Limão",                   emoji:"🍋", peso:"1 kg", preco:"2,49 €", origem:"Portugal", foto:FOTOS.limoes,       badge:"🌱 Bio" , badgeClass:"badge-new"},
      ...
      { nome:"Banana-pão",            emoji:"🍌", peso:"1 kg", preco:"2,99 €", origem:"Angola", foto:FOTOS.bananas, badge:"🆕 Novo", badgeClass:"badge-new" },
      ...
      { nome:"Ameixa Roxa Nacional",    emoji:"🟣", topVendido:true, peso:"1 kg", promo:true, precoNormal:"1,99 €", preco:"0,99 €", origem:"Nacional", foto:FOTOS.ameixa_roxa, badge:"🏷️ Promoção", badgeClass:"badge-hot" },
      { nome:"Ameixa Branca Nacional",  emoji:"🟡", peso:"1 kg", preco:"1,49 €", origem:"Nacional", status:"Indisponível", foto:FOTOS.ameixa, badge:null },
